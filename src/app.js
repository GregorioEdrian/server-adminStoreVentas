...
/* server.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'http://localhost:3000', 'https://admin-ventas-mukafe.netlify.app'); // update to match the domain you will make the request from
